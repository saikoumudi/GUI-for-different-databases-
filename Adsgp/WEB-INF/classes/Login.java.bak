...
public class Login extends HttpServlet
{
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		writer.println(	"<SCRIPT LANGUAGE=javascript>" +
						...
						"	document.loginform.url.value = \"jdbc:mysql://localhost/mysql\"; " +
						"	document.loginform.userid.focus(); " +
						"} " +
						"function setURL() { " +
						"	var i = document.loginform.driver.selectedIndex; " +
						"	if(i == 0) 		document.loginform.url.value = \"jdbc:mysql://localhost/mysql\"; " +
		...
		writer.println("<OPTION selected>com.mysql.jdbc.Driver</OPTION>");
