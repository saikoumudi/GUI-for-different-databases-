	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if(session == null) {
			...
			writer.println(	"<TR><TD>&nbsp&nbsp&nbsp&nbsp" +
							...
							"width=80 height=26 align=absbottom></A>" +
							"<img name=pic9 src='/httpadmin/pics/search2.jpg' border=0 " +
			...
			if(!error_occured) {
				writer.println("<FORM NAME=search_form METHOD=post ACTION='/httpadmin/SearchTab'>");
				...
				writer.println( "<TD ALIGN=left STYLE='background:#f5f5f5'>" +
								" <IMG NAME=pic24 SRC='/httpadmin/pics/search11.jpg' " +
			...
			if(matchCount > 0) {
				...
				for(int i=0;i<matchedColumns.size();i++) {
					...
					writer.println(	"\"<SPAN STYLE='background:yellow'>" + keyword + "</SPAN>\"" +
									...
									"<A HREF='/httpadmin/DescTab?table_name=" + tabName + "'>" +
									tabName + "</A>");
					writer.println("</TD></TR>");
				}
				...
				for(int i=0;i<matchedData.size();i++) {
					...
					writer.println("<TR><TD id=search_td>");
					writer.println(	"\"<SPAN STYLE='background:yellow'>" + keyword + "</SPAN>\"" +
									" is part of <A HREF='/httpadmin/DescTab?table_name=" + tabName + 
