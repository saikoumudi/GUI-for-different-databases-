	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if(session == null) {
			...
			writer.println(	"<TR><TD>&nbsp&nbsp&nbsp&nbsp" +
							"<img name=pic1 src='/httpadmin/pics/structure2.jpg' border=0 " +
			...
			if(error_occured) {
				...
				for(int i=0;i<colNames.size();i++) {
					...
					if(primaryKeyColumn.indexOf("," + cname + ",") != -1) {
						writer.print("<IMG SRC='/httpadmin/pics/p_key.png' WIDTH=7 HEIGHT=11>&nbsp");
					}
					if(foreignKeyColumn.indexOf("," + cname + ",") != -1) {
						writer.print("<IMG SRC='/httpadmin/pics/f_key.png' WIDTH=7 HEIGHT=11>&nbsp");
					}
					...
					writer.println(	"<TD id=common_img>" +
									"<A HREF='/httpadmin/TabOperations?table_name=" + 
