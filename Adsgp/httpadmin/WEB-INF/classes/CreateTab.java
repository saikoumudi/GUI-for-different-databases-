		...
		if(session == null) {
			...
			if(!error_occured) {
				...
				if(tableCreated) {
					...
					writer.println("	window.parent.left.location.href='/httpadmin/ListDB'; ");
					writer.println( "	window.parent.right.location.href=" +
									"'/httpadmin/DBOperations?message=" + message + "'; ");
					writer.println("} ");
			...
			if(error_occured) {
				...
				writer.println("<TR>");
				writer.println(	"<TD ALIGN=right><IMG NAME=pic11 SRC='/httpadmin/pics/reset1.jpg' " +
				...
				writer.println( "<TD ALIGN=left><IMG NAME=pic17 SRC='/httpadmin/pics/create1.jpg' " +
