	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if(session == null) {
			...
			writer.println(	"<TR><TD>&nbsp&nbsp&nbsp&nbsp" +
							...
							"width=80 height=26 align=absbottom></A>" +
							"<img name=pic4 src='/httpadmin/pics/sql2.jpg' border=0 " +
			...
			writer.println("<FORM NAME=query_form METHOD=post ACTION='/httpadmin/TabQuery'>");
			...
			writer.println(	"<IMG NAME=pic11 SRC='/httpadmin/pics/reset1.jpg' " +
			...
			writer.println( "<TD ALIGN=left STYLE='background:#f5f5f5'>" +
							"<IMG NAME=pic21 SRC='/httpadmin/pics/run1.jpg' STYLE='cursor:hand'" +
		...
		if(session == null) {
			...
			if(isDDLQuery) {
					writer.println(	"<BODY BGCOLOR=#ffffff link=black alink=black vlink=black " +
									"onLoad=\"window.parent.left.location.href='/httpadmin/ListDB';" +
									"loadImages()\">");
			}
