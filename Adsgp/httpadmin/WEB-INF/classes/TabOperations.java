	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if(session == null) {
			...
			writer.println(	"<TR><TD>&nbsp&nbsp&nbsp&nbsp" +
							"<A HREF='/httpadmin/DescTab?table_name=" + tableName + "'>" + 
							...
							"<A HREF='/httpadmin/BrowseForm?table_name=" + tableName + "'>" + 
							"<img onMouseOver='putOn(this,3)' onMouseOut='putOff(this,3)' " +
							"name=pic3 src='/httpadmin/pics/browse1.jpg' border=0 " +
							"width=80 height=26 align=absbottom></A>" +
							"<A HREF='/httpadmin/TabQuery?table_name=" + tableName + "'>" +
							"<img onMouseOver='putOn(this,4)' onMouseOut='putOff(this,4)' " +
							"name=pic4 src='/httpadmin/pics/sql1.jpg' border=0 " +
							"width=80 height=26 align=absbottom></A>" +
							"<A HREF='/httpadmin/InsertForm?table_name=" + tableName + "'>" + 
							"<img onMouseOver='putOn(this,6)' onMouseOut='putOff(this,6)' " +
							"name=pic6 src='/httpadmin/pics/insert1.jpg' border=0 " +
							"width=80 height=26 align=absbottom></A>"+
							"<A HREF='/httpadmin/ExportTab?table_name=" + tableName + "'>" +
							...
							"<A HREF='/httpadmin/SearchTab?table_name=" + tableName + "'>" +
			...
			if(!error_occured) {
				...
				writer.println("<FORM NAME=alter_form METHOD=post ACTION='/httpadmin/AlterColumn'>");
				...
				writer.println("<FORM NAME=rename_form METHOD=post ACTION='/httpadmin/RenameColumn'>");
				writer.println("<INPUT TYPE=hidden name=table_name VALUE=" + tableName + ">");
				...
				writer.println("<FORM NAME=drop_form METHOD=get ACTION='/httpadmin/DropColumn'>");
				writer.println("<INPUT TYPE=hidden NAME=table_name VALUE=" + tableName + ">");
				...
				writer.println("<FORM NAME=empty_form METHOD=get ACTION='/httpadmin/EmptyColumn'>");
				writer.println("<INPUT TYPE=hidden NAME=table_name VALUE=" + tableName + ">");
				writer.println("<INPUT TYPE=hidden NAME=primary_key VALUE='" + primaryKeyColumn + "'>");
				writer.println("<INPUT TYPE=hidden NAME=column_spec VALUE=''>");
				writer.println(	"<TABLE ALIGN=center CELLSPACING=1 CELLPADDING=2 BORDER=0 WIDTH=100% " +
				...
				writer.println("</SELECT></TD>");
				writer.println( "<TD ALIGN=center STYLE='background:#f5f5f5'>" +
								"<IMG NAME=pic20 SRC='/httpadmin/pics/empty1.jpg' STYLE='cursor:hand'" +
