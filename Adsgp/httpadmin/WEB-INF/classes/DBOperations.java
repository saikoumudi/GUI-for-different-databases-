...
public class DBOperations extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if(session == null) {
			writer.println("<HTML>");
			writer.println(	"<BODY onLoad=\"window.parent.location.href='/httpadmin/Login?message=" +
			...
			writer.println("<LINK REL='stylesheet' TYPE='text/css' HREF='/httpadmin/styles.css'>");
			writer.println( "<SCRIPT LANGUAGE='javascript' TYPE='text/javascript' " +
							" SRC='/httpadmin/script.js'></SCRIPT>");
			writer.println("</HEAD>");
			...
			writer.println(	"<TR><TD>&nbsp&nbsp&nbsp&nbsp" +
							"<A HREF='/httpadmin/DescDB'>" +
							"<img onMouseOver='putOn(this,1)' onMouseOut='putOff(this,1)' " +
							" name='pic1' src='/httpadmin/pics/structure1.jpg' border=0 " +
							" width=80 height=26 align=absbottom></A>" +
							"<A HREF='/httpadmin/DBProperties'>" +
							"<img onMouseOver='putOn(this,2)' onMouseOut='putOff(this,2)' " +
							" name='pic2' src='/httpadmin/pics/properties1.jpg' border=0 " +
							" width=80 height=26 align=absbottom></A>" +
							"<A HREF='/httpadmin/DBQuery'>" +
							"<img onMouseOver='putOn(this,4)' onMouseOut='putOff(this,4)' " +
							"name=pic4 src='/httpadmin/pics/sql1.jpg' border=0 " +
							"width=80 height=26 align=absbottom></A>" +
							"<A HREF='/httpadmin/Import'>" +
							"<img onMouseOver='putOn(this,5)' onMouseOut='putOff(this,5)' " +
							"name=pic5 src='/httpadmin/pics/import1.jpg' border=0 " +
							"width=80 height=26 align=absbottom></A>"+
							"<A HREF='/httpadmin/ExportDB'>" +
							"<img onMouseOver='putOn(this,7)' onMouseOut='putOff(this,7)' " +
							"name=pic7 src='/httpadmin/pics/export1.jpg' border=0 " +
							"width=80 height=26 align=absbottom></A>" +
							"<img name=pic8 src='/httpadmin/pics/operations2.jpg' border=0 " +
							"width=80 height=26 align=absbottom>" +
							"<A HREF='/httpadmin/SearchDB'>" + 
							"<img onMouseOver='putOn(this,9)' onMouseOut='putOff(this,9)' "+
							"name=pic9 src='/httpadmin/pics/search1.jpg' border=0 " +
			...
			if(!error_occured) {
				...
				writer.println("<FORM NAME=create_form METHOD=post ACTION='/httpadmin/CreateTab'>");
				...
				writer.println(	"<TD WIDTH=34% STYLE='background:#f5f5f5;text-align:center'>" +
								"<IMG NAME=pic14 SRC='/httpadmin/pics/add1.jpg' " +
				...
				writer.println(	"<TD WIDTH=33% STYLE='background:#f5f5f5;text-align:center'>" +
								"<IMG NAME=pic15 SRC='/httpadmin/pics/change1.jpg' BORDER=0 " +
				...
				writer.println(	"<TD WIDTH=33% STYLE='background:#f5f5f5;text-align:center'>" +
								"<IMG NAME=pic16 SRC='/httpadmin/pics/remove1.jpg' " +
				...
				writer.println(	"<TD ALIGN=right STYLE='background:#f5f5f5'>" +
								" <IMG NAME=pic11 SRC='/httpadmin/pics/reset1.jpg' " +
				...
				writer.println( "<TD ALIGN=left STYLE='background:#f5f5f5'>" +
								" <IMG NAME=pic17 SRC='/httpadmin/pics/create1.jpg' " +
				...
				writer.println("<FORM NAME='load_form' method=get ACTION='/httpadmin/DBOperations#alter'>");
				...
				writer.println("<FORM NAME=alter_form METHOD=post ACTION='/httpadmin/AlterTab'>");
				...
				writer.println(	"<TD WIDTH=33% STYLE='background:#f5f5f5;text-align:center'>" +
								"<IMG NAME=pic15 SRC='/httpadmin/pics/change1.jpg' " +
				...
				writer.println( "<TD ALIGN=left STYLE='background:#f5f5f5'>" +
								" <IMG NAME=pic18 SRC='/httpadmin/pics/apply1.jpg' " +
				...
				writer.println("<FORM NAME=rename_form METHOD=post ACTION='/httpadmin/RenameTab'>");
				writer.println(	"<TABLE ALIGN=center CELLSPACING=1 CELLPADDING=2 BORDER=0 WIDTH=100% " +
								" STYLE='border-style:double;border-width:1px;border-color:black'>");
				...
				writer.println( "<TD ALIGN=left COLSPAN=2 STYLE='background:#f5f5f5'>" +
								"<IMG NAME=pic18 SRC='/httpadmin/pics/apply1.jpg' STYLE='cursor:hand'" +
								" BORDER=0 WIDTH=70 HEIGHT=24 onMouseDown='putOn(this,18)' " +
								" onMouseUp='putOff(this,18)' onMouseOut='putOff(this,18)' " +
				...
				writer.println("<FORM NAME=drop_form METHOD=get ACTION='/httpadmin/DropTab'>");
				writer.println(	"<TABLE ALIGN=center CELLSPACING=1 CELLPADDING=2 BORDER=0 WIDTH=100% " +
								" STYLE='border-style:double;border-width:1px;border-color:black'>");
				...
				writer.println( "<TD ALIGN=center STYLE='background:#f5f5f5'>" +
								"<IMG NAME=pic19 SRC='/httpadmin/pics/drop1.jpg' STYLE='cursor:hand'" +
