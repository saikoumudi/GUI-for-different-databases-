		...
		if(session == null) {
			...
			if(error_occured) {
				...
				writer.println(	"<TR><TD>&nbsp&nbsp&nbsp&nbsp" +
								...
								"width=80 height=26 align=absbottom></A>" +
								"<img name=pic6 src='/httpadmin/pics/insert2.jpg' border=0 " +
				...
				if(lobExists) {
					writer.println(	"<FORM NAME=insert_form ACTION='/httpadmin/InsertLobs' " +
					...
					writer.println("<FORM NAME=insert_form METHOD=post ACTION='/httpadmin/InsertNorm'>");
					writer.println("<INPUT TYPE=hidden NAME=table_name VALUE=" + tableName + ">");
