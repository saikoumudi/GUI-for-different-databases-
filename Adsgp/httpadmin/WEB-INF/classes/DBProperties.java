...
public class DBProperties extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) 
		...
		if(session == null) {
			out.println("<HTML>");
			out.println(	"<BODY onLoad=\"window.parent.location.href='/httpadmin/Login?message=" +
			...
			if(!error_occured) {
				try {
					...
					out.println("<LINK REL='stylesheet' TYPE='text/css' HREF='/httpadmin/styles.css'>");
					...
					out.println("<TR><TD>&nbsp&nbsp&nbsp&nbsp" +
								...
								"<img name='pic2' src='/httpadmin/pics/properties2.jpg' border=0 " +
