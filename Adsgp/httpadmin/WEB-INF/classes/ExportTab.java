...
public class ExportTab extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) 
		...
		if(session == null) {
			...
			writer.println(	"<TR><TD>&nbsp&nbsp&nbsp&nbsp" +
							...
							"width=80 height=26 align=absbottom></A>"+
							"<img name=pic7 src='/httpadmin/pics/export2.jpg' border=0 " +
			...
			if(error_occured) writer.println("<H3>" + error_message + "</H3></BODY></HTML>");
				...
				writer.println("<FORM NAME=export_form METHOD=post ACTION='/httpadmin/ExportTab'>");
				...
				writer.println( "<TD ALIGN=left STYLE='background:#f5f5f5'>" +
								" <IMG NAME=pic22 SRC='/httpadmin/pics/export11.jpg' " +
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if(session == null) {
			...
			if(error_occured)	res.sendRedirect(	"/httpadmin/ExportDB?table_name=" + tableName + 
