...
public class Import extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) 
		...
		if(session == null) {
			...
			writer.println(	"<TR><TD>&nbsp&nbsp&nbsp&nbsp" +
							...
							" name='pic1' src='/httpadmin/pics/structure1.jpg' " +
							...
							"width=80 height=26 align=absbottom></A>" +
							"<img name=pic5 src='/httpadmin/pics/import2.jpg' border=0 " +
			...
			writer.println(	"<FORM NAME=import_form METHOD=post ACTION='/httpadmin/Import' " +
			...
			writer.println( "<TD ALIGN=center STYLE='background:#f5f5f5'>" +
							" <IMG NAME=pic23 SRC='/httpadmin/pics/import11.jpg' " +
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if(session == null) {
			...
			if(error_occured) res.sendRedirect("/httpadmin/Import?message=" + error_message);
			else {
				try {
					while(true) {
			...
			if(error_occured) {
				if(tableCreated) {
					...
					writer.println(	"	window.parent.right.location.href='/httpadmin/Import?message=" +
									error_message + "'; ");
					writer.println("} ");
				...
				else	res.sendRedirect("/httpadmin/Import?message=" + error_message);
			}
			else {
				if(tableCreated) {
					res.setContentType("text/html");
				...
				else	res.sendRedirect("/httpadmin/Import?message=Import succeeded");
			}
		}
	}
}