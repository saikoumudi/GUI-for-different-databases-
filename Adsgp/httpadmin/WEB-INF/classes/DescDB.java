		...
		if(session == null) {
			...
			if(error_occured) {
				...
				writer.println(	"<TR><TD>&nbsp&nbsp&nbsp&nbsp" +
								"<img name='pic1' src='/httpadmin/pics/structure2.jpg' " +
								...
								"width=80 height=26 align=absbottom></A>" +
								"<A HREF='/httpadmin/DBOperations'>" +
								"<img onMouseOver='putOn(this,8)' onMouseOut='putOff(this,8)' " +
								"name=pic8 src='/httpadmin/pics/operations1.jpg' border=0 " +
								"width=80 height=26 align=absbottom></A>" +
				...
				for(int i=0;i<tableNames.size();i++) {
					...
					writer.println("<TR>");
					writer.println(	"<TD id=common_td><A HREF='/httpadmin/DescTab?table_name=" + tname + 
									"'>" + tname + "</A></TD>");
					...
					writer.println(	"<TD id=common_img>" +
									"<A HREF='/httpadmin/BrowseForm?table_name=" + tname + "'>" +
									"<IMG WIDTH=12 HEIGHT=13 BORDER=0 ALT=browse " +
									"SRC='/httpadmin/pics/button_browse.png'></A></TD>");
					writer.println(	"<TD id=common_img>" +
									"<A HREF='/httpadmin/SearchTab?table_name=" + tname + "'>" +
									"<IMG WIDTH=14 HEIGHT=13 BORDER=0 ALT=search " +
									"SRC='/httpadmin/pics/button_search.png'></A></TD>");
					writer.println(	"<TD id=common_img>" +
									"<A HREF='/httpadmin/InsertForm?table_name=" + tname + "'>" +
									"<IMG WIDTH=18 HEIGHT=13 BORDER=0 ALT=insert " +
									"SRC='/httpadmin/pics/button_insert.png'></A></TD>");
					writer.println(	"<TD id=common_img>" +
									"<A HREF='/httpadmin/ExportTab?table_name=" + tname + "'>" +
									"<IMG WIDTH=13 HEIGHT=13 BORDER=0 ALT=export " +
									"SRC='/httpadmin/pics/button_export.png'></A></TD>");
					writer.println(	"<TD id=common_img>" +
									"<A HREF='/httpadmin/DBOperations?tname=" + 
									tname + "&command=alter#alter'>" +
									"<IMG WIDTH=12 HEIGHT=13 BORDER=0 ALT=alter " +
									"SRC='/httpadmin/pics/button_edit.png'></A></TD>");
					writer.println(	"<TD id=common_img>" +
									"<A HREF='/httpadmin/DBOperations?tname=" + 
									tname + "&command=rename#rename'>" +
									"<IMG WIDTH=11 HEIGHT=13 BORDER=0 ALT=rename " +
									"SRC='/httpadmin/pics/button_rename.png'></A></TD>");
					writer.println( "<TD id=common_img><IMG WIDTH=11 HEIGHT=13 BORDER=0 ALT=drop " +
									" SRC='/httpadmin/pics/button_drop.png' STYLE='cursor:hand' " +
									" onClick=callDropTab('" + tname + "')></TD>");
					writer.println(	"<TD id=common_img><IMG WIDTH=11 HEIGHT=13 BORDER=0 ALT=empty " +
									" SRC='/httpadmin/pics/button_empty.png' STYLE='cursor:hand' " +
